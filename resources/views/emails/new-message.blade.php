...
@section('content')
<h2 style="font-size: 20px; font-weight: 300; line-height: 28px; color: {{ $mainTextColor }}; margin: 16px 0; text-align: center;">Hello, {{ $username }}. You have received a new message from {{ $senderName }} on {{ config('app.name') }}.</h2>
@endsection
@section('button')
